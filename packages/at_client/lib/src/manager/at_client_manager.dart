...
class AtClientManager {
  ...
  Future<AtClientManager> setCurrentAtSign(
    ...
    AtClientCommitLogCompaction.getInstance()
      ..atCommitLog = atCommitLog!
      ..atCompactionJob =
          AtCompactionJob(atCommitLog, secondaryPersistentStore!)
      ..secondaryKeyStore = secondaryPersistentStore.getSecondaryKeyStore()!
      ..scheduleCompaction(AtClientConfig.getInstance().commitLogCompactionTimeIntervalInMins);
    return this;
  }
